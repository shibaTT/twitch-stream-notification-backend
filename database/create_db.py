...
cur.execute(
    "CREATE TABLE IF NOT EXISTS streamers (streamer_id VARCHAR(32) PRIMARY KEY, streamer_login_id VARCHAR(32), channel_id VARCHAR(32), is_active BOOLEAN, created_at datetime, updated_at datetime, deleted_at datetime)"
)
